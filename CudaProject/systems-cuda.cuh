...
struct XY_silicon_anisotrop_subsystems_obc : public subsystems_pbc, public XY_Silicon_anisotrop, public System_OBC {
public:
    XY_silicon_anisotrop_subsystems_obc(map<Parameter, double> paras) : XY_model(paras),
                                                                    subsystems(paras),
                                                                    subsystems_pbc(paras),
                                                                    XY_Silicon(paras),
                                                                    XY_Silicon_anisotrop(paras),
