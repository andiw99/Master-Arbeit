...
def main():
    ...
    root = "../../Generated content/Coulomb Constant/Random Init Test"
    if len(sys.argv) >= 2:
    ...
    for filepath in filepaths[::-1]:
        ...
        if os.path.basename(filepath) == "0.csv":
            ...
            plot_multiple_times(read_csv(filepath), read_parameters_txt(para_filepath),
                                ...
                                storage_root=plot_root, p=False, show=True, chess_board=chess_trafo)
        ...
        if os.path.splitext(filepath)[1] == ".csv":
            ...
            plot_multiple_times(read_csv(filepath), read_parameters_txt(para_filepath),
                                nr_plots_per_dimension ** 2, proj,
                                storage_root=storage_path, p=False, name=name)
