...
def main():
    ...
    simpath = "../../Generated content/Final/z-measurement-small/h=2/2/z"
    ...
    size_cum_dic, size_times_dic = z_measurement.get_results_time_resolved(sizes, simpath, Tc=2.290000, file_ending="mag", value_name="U_L",
